...
entry benchUnoptimized [m] [n] (A : [m][n]f32) =
    ...
    in RankSearchK.humanReasoningBatchRankSearch ks A shp II1
...
entry benchOptimized [m] [n] (A : [m][n]f32) =
    ...
    in RankSearchK.humanReasoningBatchRankSearchOptimized ps ks shp II1 A
...
entry benchCompilerFlattened [m] [n] (A : [m][n]f32) =
    ...
    let shp = replicate m n_elem
    let ks = replicate m (n_elem/2)
    in RankSearchK.compilerThinkingBatchRankSearch ks A shp